...
|-------------|--------------------------------|---------------------------------------------------------------------|
| 3.0.13      | 22-07-2026                     |New analytic rule: detect unaudited custom apps with login-only activity. Renamed analytic rules with `SAP BTP` prefix for improved discoverability.|
